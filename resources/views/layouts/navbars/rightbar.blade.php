<div class="end-bar">
    ...
    <div class="rightbar-title">
        ...
        <h5 class="m-0">Configurações de Layout</h5>
    </div>
    ...
    <div class="rightbar-content h-100" data-simplebar>
        ...
        <div class="p-3">
            ...
            <div class="form-check form-switch mb-1">
                ...
                <label class="form-check-label" for="light-check">Clara</label>
            </div>

            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" name="theme" value="dark" id="dark-check">
                <label class="form-check-label" for="dark-check">Escura</label>
            </div>
            ...
            <div class="form-check form-switch mb-1">
                ...
                <label class="form-check-label" for="scrollable-check">Com rolagem</label>
            </div>
